<?php
	...
	class SizeCalculator {
		...
		public function printSVG($embedded = false) {
			...
			$human_width = $human_height * 134/720; //from svg viewbox
			
			$eye_x = $human_width * 92 / 134;
			$eye_y = $human_height * 48 / 720;
...
<svg id="observer" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 {$image_width} {$image_height}">
	...
	<!-- the observer -->
	<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="{$human_x}" y="{$human_y}" width="{$human_width}" height="{$human_height}" viewBox="0 0 134 720">
